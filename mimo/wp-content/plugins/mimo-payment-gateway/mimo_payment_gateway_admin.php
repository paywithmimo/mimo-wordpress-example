<?php 
	if($_POST['mimo_hidden'] == 'Y') { 
		...
		$mi_oauth_url_rf = esc_url($_POST['mi_oauth_url_rf']);
		update_option('mi_oauth_url_rf', $mi_oauth_url_rf);
		
		$mi_oauth_url_void = esc_url($_POST['mi_oauth_url_void']);
		update_option('mi_oauth_url_void', $mi_oauth_url_void);
...
<p><span class="ttl01"><?php _e("OAuth Callback URL for Refund : " ); ?></span>
<input type="text" name="mi_oauth_url_rf" value="<?php echo $mi_oauth_url_rf; ?>" size="20"></p>
<p><span class="ttl01"><?php _e("OAuth Callback URL for Void : " ); ?></span>
<input type="text" name="mi_oauth_url_void" value="<?php echo $mi_oauth_url_void; ?>" size="20"></p>
